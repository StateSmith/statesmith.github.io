...
class Ex04
 extends Ex10Base{
    ...
    dispatchEvent(/** @type {Ex04.EventId} */ eventId)
    {
    ...
    #exitUpToStateHandler(/** @type {Ex04.Func} */ desiredStateExitHandler)
    {
...
;
    ...
    // Thread safe.
    stateIdToString(/** @type {Ex04.StateId} */ id)
    {
        switch (id)
        {
    ...
    // Thread safe.
    eventIdToString(/** @type {Ex04.EventId} */ id)
    {
        switch (id)
        {
