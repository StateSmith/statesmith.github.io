...
class Ex09
 extends Ex10Base{
    ...
    dispatchEvent(/** @type {Ex09.EventId} */ eventId)
    {
    ...
    #exitUpToStateHandler(/** @type {Ex09.Func} */ desiredStateExitHandler)
    {
...
;
    ...
    // Thread safe.
    stateIdToString(/** @type {Ex09.StateId} */ id)
    {
        switch (id)
        {
    ...
    // Thread safe.
    eventIdToString(/** @type {Ex09.EventId} */ id)
    {
        switch (id)
        {
