...
class Ex12 extends Ex10Base
{
    ...
    // Used internally by state machine. Don't modify.
    #currentEventHandlers = Array(Ex12.EventIdCount).fill(undefined);
    ...
    #OFF_enter()
    {
        ...
        this.#currentEventHandlers[Ex12.EventId.INCREASE] = this.#OFF_increase;
    ...
    #OFF_increase()
    {
        ...
        // OFF behavior
        // uml: INCREASE / { trace_transition("37"); } TransitionTo(ON2)
        {
    ...
    #ON_GROUP_enter()
    {
        ...
        this.#currentEventHandlers[Ex12.EventId.OFF] = this.#ON_GROUP_off;
    ...
    #ON_GROUP_exit()
    {
        ...
        // adjust function pointers for this state's exit
        this.#currentStateExitHandler = this.#ROOT_exit;
        this.#currentEventHandlers[Ex12.EventId.OFF] = null;  // no ancestor listens to this event
    }
    ...
    #ON_HOT_dim()
    {
        ...
        // ON_HOT behavior
        // uml: OFF, DIM / { trace_action("// eat the event.\\n// stay until time.", "42", "OFF, DIM / { // eat the event.\\n// stay until time. }");// eat the event.\n// stay until time. }
        {
            // Step 1: execute action `trace_action("// eat the event.\\n// stay until time.", "42", "OFF, DIM / { // eat the event.\\n// stay until time. }");// eat the event.\n// stay until time.`
            this.trace_action("// eat the event.\\n// stay until time.", "42", "OFF, DIM / { // eat the event.\\n// stay until time. }");// eat the event.
            // stay until time.<EOF>
    ...
    #ON_HOT_off()
    {
        ...
        this.#ancestorEventHandler = this.#ON_GROUP_off;
    ...
    #ON2_enter()
    {
        ...
        this.#currentEventHandlers[Ex12.EventId.DIM] = this.#ON2_dim;
        this.#currentEventHandlers[Ex12.EventId.INCREASE] = this.#ON2_increase;
    ...
    #ON2_increase()
    {
        ...
        // uml: INCREASE / { trace_transition("31"); } TransitionTo(ON_HOT)
        {
            ...
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.stateId = Ex12.StateId.ON_HOT;
            // No ancestor handles event. Can skip nulling `ancestorEventHandler`.
            return;
        } // end of behavior for ON2
    }
    ...
    static stateIdToString(id)
    {
        switch (id)
        {
            case Ex12.StateId.ROOT: return "ROOT";
            case Ex12.StateId.OFF: return "OFF";
            case Ex12.StateId.ON_GROUP: return "ON_GROUP";
            case Ex12.StateId.ON_HOT: return "ON_HOT";
            case Ex12.StateId.ON2: return "ON2";
            default: return "?";
        }
    }
    ...
    static eventIdToString(id)
    {
        switch (id)
        {
            case Ex12.EventId.DIM: return "DIM";
            case Ex12.EventId.DO: return "DO";
            case Ex12.EventId.INCREASE: return "INCREASE";
            case Ex12.EventId.OFF: return "OFF";
            default: return "?";
        }
    }
}
